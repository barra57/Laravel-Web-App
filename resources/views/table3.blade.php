...
<!--    <button
  ...
  <h5><span><a href="/form"><button type="button"class="btn btn-primary mr-2 mb-2">Create translate form</button></a></span> </h5>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
      <strong>Table Translate</strong>
    </h4>
    <div class="table-responsive mb-5">
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($tabeltranslate as $tabeltranslates)
          <tr>
            <td>{{$tabeltranslates['name']}}</td>
            <td>{{$tabeltranslates['NIM']}}</td>
            <td>{{$tabeltranslates['email']}}</td>
            <td>{{$tabeltranslates['book']}}</td>
            <td><a href="/tabletranslate/edit3/{{$tabeltranslates->NIM}}" ><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
              </button></a></td>
            <td><a href="/tabletranslate/delete/{{$tabeltranslates->NIM}}"><span class="btn btn-danger mr-1 mb-1">X</span></a></td>
          </tr>
        @endforeach
        </tbody>
        <tfoot>
