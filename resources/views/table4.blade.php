...
<body class="air__menu--gray">
  ...
  <h5><span><a href="/form4"><button type="button"class="btn btn-primary mr-2 mb-2">Log</button></a></span> </h5>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($logs as $log)
          <tr>
            ...
            <td>{{$log['email']}}</td>
            <td>{{$log['logs']}}</td>
            <td><a href="/logs/delete4/{{$log->NIM}}"><span class="btn btn-danger mr-1 mb-1">X</span</a></td>
          </tr>
        @endforeach
        </tbody>
        <tfoot>
