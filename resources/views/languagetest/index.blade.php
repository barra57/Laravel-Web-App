      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        <tbody>
          ...
          <tr>
            <td>{{$ujian['No']}}</td>
            <td>{{$ujian['Nama']}}</td>
            <td>{{$ujian['Tanggaldaftar']}}</td>
            <td>{{$ujian['Ujian']}}</td>
            <td>{{$ujian['Tanggalujian']}}</td>
            <td>{{$ujian['Sesi']}}</td>
            <td><a href="{{ route('client.test') }}"><button type="button" class="btn btn-success"><i class="fe fe-edit mr-1" aria-hidden="true"></i>Start Test</button></a></td>
