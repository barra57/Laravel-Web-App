...
<!--    <button
  ...
  <h5><h5><span><a href="{{ route("admin.options.create") }}"><button type="button"class="btn btn-primary mr-2 mb-2">Create Options</button></a></span> </h5></h5>
</div>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($options as $key => $option)
          <tr data-entry-id="{{ $option->id }}">
            ...
            <td>
                @can('option_show')
                <a href="{{ route('admin.options.show', $option->id) }}"><button type="button" class="btn btn-primary">
            ...
            <td>
                @can('option_edit')
                <a href="{{ route('admin.options.edit', $option->id) }}"><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
                </button></a>
                @endcan
