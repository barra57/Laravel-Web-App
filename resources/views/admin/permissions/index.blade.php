    ...
    <div class="air__layout">
      ...
      <div class="air__layout__content">
        <div class="air__utils__content">
          ...
          <h5><span class="mr-3"><strong>Table Permissions</strong></span></h5> 
</div>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($permissions as $key => $permission)
          <tr data-entry-id="{{ $permission->id }}">
            ...
            <td>
                @can('permission_show')
                <a href="{{ route('admin.permissions.show', $permission->id) }}"><button type="button" class="btn btn-primary">
            ...
            <td>
                @can('permission_edit')
                <a href="{{ route('admin.permissions.edit', $permission->id) }}"><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
                </button></a>
                @endcan
