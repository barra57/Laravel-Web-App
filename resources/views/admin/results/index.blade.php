      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($results as $key => $result)
          <tr data-entry-id="{{ $result->id }}">
            ...
            <td>
                @can('result_show')
                <a href="{{ route('admin.results.show', $result->id) }}"><button type="button" class="btn btn-primary">
            ...
            <td>
                @can('result_edit')
                <a href="{{ route('admin.results.edit', $result->id) }}"><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
                </button></a>
                @endcan
