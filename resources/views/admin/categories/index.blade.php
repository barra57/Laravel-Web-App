...
<!--    <button
  ...
  <h5><h5><span><a href="{{ route("admin.categories.create") }}"><button type="button"class="btn btn-primary mr-2 mb-2">Create Categories</button></a></span> </h5></h5>
</div>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($categories as $key => $category)
          <tr data-entry-id="{{ $category->id }}">
            ...
            <td>
                @can('category_show')
                <a href="{{ route('admin.categories.show', $category->id) }}"><button type="button" class="btn btn-primary">
            ...
            <td>
                @can('category_edit')
                <a href="{{ route('admin.categories.edit', $category->id) }}"><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
                </button></a>
                @endcan
