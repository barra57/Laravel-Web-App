    ...
    <div class="air__layout">
      ...
      <div class="air__layout__content">
        <div class="air__utils__content">
          ...
          <h5><span class="mr-3">Table Users</span></h5> 
</div>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
    <h5><h5><span><a href="{{ route("admin.users.create") }}"><button type="button"class="btn btn-primary mr-2 mb-2">Create Users</button></a></span> </h5></h5>
    </h4>
      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($users as $key => $user)
          <tr data-entry-id="{{ $user->id }}">
            ...
            <td>
                @can('user_show')
                <a href="{{ route('admin.users.show', $user->id) }}"><button type="button" class="btn btn-primary">
            ...
            <td>
                @can('user_edit')
                <a href="{{ route('admin.users.edit', $user->id) }}"><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
                </button></a>
                @endcan
            ...
            <td>
                ...
                <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
                                        ...
                                        <input type="submit" class="btn btn-danger mr-1 mb-1" value="{{ trans('global.delete') }}">
                </form>
                @endcan                            
          </tr>
        </tbody>
