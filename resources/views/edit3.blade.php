  ...
  <div class="card-body">
    <h4 class="mb-4">
      <div class="form-group"> 
    	@foreach($tabeltranslate as $tabeltranslates)
		<form action="/update" method="POST">
		{{ csrf_field() }}
			<input type="hidden" name="NIM" value="{{ $tabeltranslates->NIM }}"> <br/>
			<label for="editname">Name</label>
      <input type="text" class="form-control" required="required" name="name" value="{{ $tabeltranslates->name }}"> <br/>
      <label for="editnim">NIM</label>
      <input type="number" class="form-control" required="required" name="NIM" value="{{ $tabeltranslates->NIM }}"> <br/>
      <label for="editemail">Email</label>
			<input type="text" class="form-control" required="required" name="email" value="{{ $tabeltranslates->email }}"> <br/>
      <label for="editemail">Book Title</label>
			<input type="text" class="form-control" required="required" name="book" value="{{ $tabeltranslates->book }}"> <br/>
