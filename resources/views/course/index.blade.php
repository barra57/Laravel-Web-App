...
<body class="air__menu--gray">
  ...
  <h5><h5><span><a href="/course/create"><button type="button"class="btn btn-primary mr-2 mb-2">Create Course form</button></a></span> </h5></h5>
</div>
<div class="card">
  <div class="card-body">
    <h4 class="mb-4">
      ...
      <table class="table table-hover nowrap editable-table" id="example1">
        ...
        @foreach($tabelcourses as $tabelcourse)
          <tr>
            ...
            <td>><a href="/course/show" ><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Show
              </button></a></td>
            <td>><a href="/course/result" ><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Result
            </button></a></td>
            <td><a href="/course/index/edit/{{$tabelcourse->NIM}}" ><button type="button" class="btn btn-success">
                <i class="fe fe-edit mr-1" aria-hidden="true"></i>
                Edit
              </button></a></td>
            <td><a href="/course/index/destroy/{{$tabelcourse->NIM}}"><span class="btn btn-danger mr-1 mb-1">X</span</a></td>
          </tr>
        @endforeach
        </tbody>
        <tfoot>
