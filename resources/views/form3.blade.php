  ...
  <div class="card-body">
    <h4 class="mb-4">
      ...
      {{ csrf_field() }}
        ...
        <input type="text" class="form-control" id="soal" name="soal"required="required"/>
        <label for="inputname">Opsi 1</label>
        <input type="text" class="form-control" id="opsi1" name="opsi1"required="required"/>
        <label for="inputname">Opsi 2</label>
        <input type="text" class="form-control" id="opsi2" name="opsi2"required="required"/>
        <label for="inputname">Opsi 3</label>
        <input type="text" class="form-control" id="opsi3" name="opsi3"required="required"/>
        <label for="inputname">Opsi 4</label>
        <input type="text" class="form-control" id="opsi4" name="opsi4"required="required"/>
        <label for="inputname">Jawaban Benar</label>
        <input type="text" class="form-control" id="benar" name="benar"required="required"/>
        <br>
