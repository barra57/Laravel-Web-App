...
<body>
  ...
  <div class="air__auth__container pl-5 pr-5 pt-5 pb-5 bg-white text-center">
    <div class="text-dark font-size-30 mb-4">Sign Up</div>
    ...
    <div class="font-size-18">
      ...
      <a href="#" class="text-blue font-weight-bold font-size-18">Terms of Service</a> and
      <a href="#" class="text-blue font-weight-bold font-size-18">Privacy Policy</a>
    </div>
  </div>
  <div class="text-center font-size-18 pt-4 mb-auto">
    Already have an account?
    <a href="{{ route('login') }}" class="font-weight-bold text-blue text-underlined"><u>Log In</u></a>
  </div>
